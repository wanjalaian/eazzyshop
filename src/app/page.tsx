...
import { Store, MessageSquare, Smartphone, Zap, ArrowRight, CheckCircle, ShieldCheck, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7] text-[#1A1A19] font-sans antialiased">
      ...
      <section className="pt-16 pb-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 bg-[#F5F0EB] border border-[#E8E2DC] px-3.5 py-1.5 rounded-full text-xs font-bold text-[#C4653A] mb-8">
          <Zap size={14} className="fill-[#C4653A]" /> ZERO COMMISSIONS • NO PAYMENT GATEWAYS
        </div>

        <h1 className="font-heading text-4xl sm:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.08] text-[#1A1A19] mb-6">
          Sell on WhatsApp. <br />
          <span className="text-[#C4653A]">No technical headache.</span>
        </h1>

        <p className="text-base sm:text-xl text-[#6B6560] max-w-2xl mx-auto mb-10 leading-relaxed">
          Create a mobile-first catalog in 2 minutes. Share your link on Instagram, TikTok & WhatsApp. Receive clean, formatted order carts sent directly to your phone.
        </p>

        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <Link
            href="/register"
            className="w-full sm:w-auto px-8 py-4 bg-[#1A1A19] hover:bg-[#1A1A19]/90 text-white rounded-xl font-bold text-sm tracking-wider uppercase flex items-center justify-center gap-2 transition-all shadow-md hover:shadow-lg"
          >
          ...
          <Link
            href="/login"
            className="w-full sm:w-auto px-8 py-4 bg-white border border-[#E8E2DC] hover:bg-[#F5F0EB] text-[#1A1A19] rounded-xl font-bold text-sm transition-colors flex items-center justify-center"
          >
            Sign In to Dashboard
          </Link>
        </div>

        {/* Live Order Mockup Preview */}
        <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-[#E8E2DC] p-6 shadow-xl text-left font-sans">
          <div className="flex items-center gap-3 border-b border-[#E8E2DC] pb-4 mb-4">
            <div className="w-3 h-3 rounded-full bg-emerald-500" />
            <span className="text-xs font-bold text-[#1A1A19] uppercase tracking-wider">What your WhatsApp order looks like</span>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto border-t border-[#E8E2DC]">
        <div className="text-center mb-16">
          <h2 className="font-heading text-3xl sm:text-4xl font-bold text-[#1A1A19] mb-4">
            Why social sellers switch to EazzyShop
          </h2>
          <p className="text-[#6B6560] max-w-xl mx-auto text-sm sm:text-base">
            Skip complicated e-commerce builders that take weeks to set up and demand monthly gateway subscriptions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl border border-[#E8E2DC] shadow-sm flex flex-col gap-4">
            ...
            <h3 className="font-heading text-lg font-bold text-[#1A1A19]">Variants Ready Out-of-the-Box</h3>
          ...
          <div className="bg-white p-8 rounded-2xl border border-[#E8E2DC] shadow-sm flex flex-col gap-4">
            ...
            <h3 className="font-heading text-lg font-bold text-[#1A1A19]">1-Tap WhatsApp Re-engagement</h3>
            <p className="text-[#6B6560] text-sm leading-relaxed">
              Auto-log customer phones and order history. Message repeat buyers directly on WhatsApp with new catalog drops.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 bg-[#1A1A19] text-white text-center">
        <div className="max-w-4xl mx-auto space-y-6">
          <h2 className="font-heading text-3xl sm:text-5xl font-bold tracking-tight">
            Ready to streamline your WhatsApp sales?
          </h2>
          ...
          <div className="pt-4">
            <Link
              href="/register"
              className="inline-flex items-center gap-2 px-8 py-4 bg-[#C4653A] hover:bg-[#A8522E] text-white font-bold text-sm rounded-xl uppercase tracking-wider transition-all"
            >
              Build My Store Now
              <ArrowRight size={18} />
            </Link>
